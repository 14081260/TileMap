class Person{
    ...
    public SetState(e : PersonState , _tmain : Main){
        this.IdleOrWalkStateMachine.setState(e,_tmain);
    }

    public SetRightOrLeftState(e : PersonState , _tmain : Main){
...
class PeopleState implements PersonState{
      OnState(_tmain : Main){};
...
class StateMachine{
     ...
     setState( e : PersonState , _tmain : Main){
